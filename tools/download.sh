...
# Image Features
wget -P data -c https://imagecaption.blob.core.windows.net/imagecaption/trainval.zip
# wget -P data -c https://imagecaption.blob.core.windows.net/imagecaption/test2014.zip
wget -P data -c https://imagecaption.blob.core.windows.net/imagecaption/test2015.zip
...
mkdir -p data/cache
wget --no-check-certificate 'https://drive.google.com/uc?export=download&id=1m5pL9gOkcnLZ_NuANmnDFIcil3NQVmZc' -O -c data/cache/cache.pkl.tgz
